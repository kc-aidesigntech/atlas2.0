// Execution service builds participant-scoped timelines, blockers, and service-level risk snapshots.
import { toMillis } from '@/services/atlas2026/snapshotHelpers'
...
export function buildExecutionSnapshot({
  ...
  selectedParticipant?: ParticipantSnapshot | null
