// Situational service compares participant pressure with partner capacity to identify corridor priorities.
import { PRESSURE_DOMAINS } from '@/core/atlas2026/canonical-spec'
import { average, toPhaseReadinessAlert, toRoundedNumber } from '@/services/atlas2026/snapshotHelpers'
import type { ParticipantSnapshot } from '@/services/atlas2026/snapshotHelpers'
...
export function buildSituationalOverlay({
  participants,
  capacityTopology,
  phaseReadinessAlertThreshold = 0.45
}: {
  participants: ParticipantSnapshot[]
  capacityTopology: CapacityNode[]
