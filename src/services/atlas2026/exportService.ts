// Export helpers serialize tabular records and trigger browser-based comma-separated value downloads.
...
export function toCsv(rows: CsvRow[] | null | undefined): string {
...
export function downloadCsv(rows: CsvRow[] | null | undefined, filename: string): void {
