...
export default function SinglePaneWorkspace() {
  const {
    role,
    viewerRole,
    setRole,
  ...
  } = useWorkspaceOverlayRouter<(typeof partnerStationSpecialties)[number]>()
  ...
  return (
    ...
    >
        ...
        {(isLoading || !isReady) && !bootstrapError ? <WorkspaceLoadingSpinner /> : null}
        {bootstrapError ? (
